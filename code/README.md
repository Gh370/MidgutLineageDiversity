 * Taking the first sample obtained on day 3 (S1_3d) as an example, EffectivePopulationSize.R and ClonalDiversity.R demonstrate how to calculate the effective population size (Ne) and clonal diversity.
